...
"""Verify that starting cypher with -h works as expected."""

from test_framework.test_framework import CypherTestFramework
from test_framework.util import assert_equal

class HelpTest(CypherTestFramework):
    ...
    def run_test(self):
        self.log.info("Start cypher with -h for help text")
        ...
        self.log.info("Start cypher with -version for version information")
        ...
        self.log.info("Start cypherd with -fakearg to make sure it does not start")
