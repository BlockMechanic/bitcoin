...
class SegWitTest(CypherTestFramework):
    ...
    def test_p2sh_witness(self):
        ...
        # segwit activation.  Note that older cypherd's that are not
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let cypherd fill it in.
