...
class P2PPermissionsTests(CypherTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].cypherconf, encoding="utf8") as f:
            newText=f.read().replace(old, new)
        with open(self.nodes[nodeid].cypherconf, 'w', encoding="utf8") as f:
            f.write(newText)
