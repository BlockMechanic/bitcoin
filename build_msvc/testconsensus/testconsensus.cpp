...
// cypher includes.
#include <..\src\script\cypherconsensus.h>
...
int main()
{
    std::cout << "cypherconsensus version: " << cypherconsensus_version() << std::endl;
    ...
    auto op0Result = cypherconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, cypherconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
