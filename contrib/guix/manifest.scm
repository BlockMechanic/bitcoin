...
(define* (make-cypher-cross-toolchain target
                                  #:key
...
desirable for building Cypher Core release binaries."
...
(packages->manifest
 (list ;; The Basics
       ...
       (make-cypher-cross-toolchain "i686-linux-gnu")
       (make-cypher-cross-toolchain "x86_64-linux-gnu")
       (make-cypher-cross-toolchain "aarch64-linux-gnu")
       (make-cypher-cross-toolchain "arm-linux-gnueabihf")
       ...
       (make-cypher-cross-toolchain "riscv64-linux-gnu"
