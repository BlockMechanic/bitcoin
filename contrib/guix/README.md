# Bootstrappable Cypher Core Builds

This directory contains the files necessary to perform bootstrappable Cypher
Core builds.
...
- 24GB of free disk space on the partition that the Cypher Core git repository
  resides in
...
For a Cypher Core depends development environment, simply invoke
...
From the top of a clean Cypher Core repository:
...
To use dongcarl's substitute server for Cypher Core builds after having
