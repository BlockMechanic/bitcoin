...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the cypher repository."
  exit 1
fi
...
# See https://github.com/cypher/cypher/issues/16064
...
echo 'When compiling cypherd, run `./configure` in the following way:'
echo
