Cypher Core version 0.10.4 is now available from:

  <https://cypher.org/bin/cypher-core-0.10.4/>
...
- #6953 `43c2789` Split cypher-tx into its own package
- #6953 `dfe0d4d` Include cypher-tx binary on Debian/Ubuntu
