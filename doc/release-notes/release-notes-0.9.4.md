Cypher Core version 0.9.4 is now available from:

  https://cypher.org/bin/0.9.4/
...
this update is incompatible with the Cypher system and could lead to consensus
forks.

Cypher Core released binaries from https://cypher.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~cypher/+archive/ubuntu/cypher
- A third-party or self-compiled Cypher Core

upgrade to Cypher Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
