Cypher Core version 0.16.1 is now available from:

  <https://cyphercore.org/bin/cypher-core-0.16.1/>
...
- #12843 `df38b13` Test starting cypherd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure cypherd processes are cleaned up when tests end (sdaftuar)
