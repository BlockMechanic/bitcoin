Cypher Core version 0.16.3 is now available from:

  <https://cyphercore.org/bin/cypher-core-0.16.3/>
...
been discovered in Cypher Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` cypherconsensus: invalid flags error should be set to `cypherconsensus_err` (afk11)
