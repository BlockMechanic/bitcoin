Cypher Core version 0.10.3 is now available from:

  <https://cypher.org/bin/cypher-core-0.10.3/>
...
(see https://github.com/cypher/cypher/pull/6793, as well as the 0.11.0
