Cypher Core version 0.13.2 is now available from:

  <https://cypher.org/bin/cypher-core-0.13.2/>
...
- #8908 `4a974b2` Update cypher-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow cypher-tx to create v2 transactions (btcdrak)
