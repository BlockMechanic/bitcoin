Cypher version 0.5.4 is now available for download at:
http://sourceforge.net/projects/cypher/files/Cypher/cypher-0.5.4/
...
http://gitorious.org/cypher/cypherd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Cypher-Qt notifications under Growl 1.3.
Increase required age of Cypher-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxCypher properly when installing Cypher-Qt over it. (Windows)
