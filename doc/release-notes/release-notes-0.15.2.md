Cypher Core version *0.15.2* is now available from:

  <https://cyphercore.org/bin/cypher-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in cypher-tx (TheBlueMatt)
