Cypher-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/cypher/files/Cypher/cypher-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Cypher
...
New/changed settings (command-line or cypher.conf file)
--------------------------------------------------------
