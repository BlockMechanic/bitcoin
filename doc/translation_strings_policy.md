...
This document provides guidelines for internationalization of the Cypher Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `cypher_en.ts` remains unchanged.
