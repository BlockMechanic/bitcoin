...
#ifndef CYPHER_COINS_H
#define CYPHER_COINS_H
...
public:
    ...
    /**
     * Amount of cyphers coming in to a transaction
 ...
 * between cypherd, and cypher-qt and non-server tools.
 *
