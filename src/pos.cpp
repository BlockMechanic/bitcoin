...
//   a proof-of-work situation.
//
bool CheckStakeKernelHashV2(const CBlockIndex* pindexPrev, unsigned int nBits, const CCoins* txPrev, const COutPoint& prevout, unsigned int nTimeTx, bool fPrintProofOfStake)
{
...
bool CheckStakeKernelHash(const CBlockIndex* pindexPrev, unsigned int nBits, const CCoins* txPrev, const COutPoint& prevout, unsigned int nTimeTx, bool fPrintProofOfStake)
{
    ...
    // Potcoin ToDo: fix
    // else
        // return CheckStakeKernelHashV1(nBits, );
}
