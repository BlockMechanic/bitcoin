// Copyright (c) 2012-2019 The Cypher Core developers
...
{
    BOOST_CHECK(TestSplitHost("www.cyphercore.org", "www.cyphercore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.cyphercore.org]", "www.cyphercore.org", -1));
    BOOST_CHECK(TestSplitHost("www.cyphercore.org:80", "www.cyphercore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.cyphercore.org]:80", "www.cyphercore.org", 80));
