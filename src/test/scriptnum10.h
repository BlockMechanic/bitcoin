...
#ifndef CYPHER_TEST_SCRIPTNUM10_H
#define CYPHER_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Cypher Core 0.10.0, for cross-comparison.
 */
public:
