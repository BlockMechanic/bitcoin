...
#ifndef CYPHER_CRYPTO_CHACHA_POLY_AEAD_H
#define CYPHER_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@cypher.
 *
 ...
 *
 * The chacha20-poly1305@cypher combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@cypher cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@cypher are relatively fast in
...
#endif // CYPHER_CRYPTO_CHACHA_POLY_AEAD_H
