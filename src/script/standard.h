...
#ifndef CYPHER_SCRIPT_STANDARD_H
#define CYPHER_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a cypher address
 */
...
/**
 * Generate a Cypher scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // CYPHER_SCRIPT_STANDARD_H
