...
#ifndef CYPHER_QT_CYPHERUNITS_H
#define CYPHER_QT_CYPHERUNITS_H
...
/** Cypher unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class CypherUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit CypherUnits(QObject *parent);

    /** Cypher units.
      @note Source: https://en.cypher.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTC,
...
typedef CypherUnits::Unit CypherUnit;

#endif // CYPHER_QT_CYPHERUNITS_H
