...
//! Entry point for CypherApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &CypherApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for CypherGUI tests.
void AppTests::guiTests(CypherGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &CypherGUI::consoleShown, this, &AppTests::consoleTests);
