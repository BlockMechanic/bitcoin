    ...
    platformStyle(_platformStyle)
{
    ...
    // normal cypher address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying cypher address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &CypherAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
