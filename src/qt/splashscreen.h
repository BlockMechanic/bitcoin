...
#ifndef CYPHER_QT_SPLASHSCREEN_H
#define CYPHER_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. Cypher Core initialization
...
#endif // CYPHER_QT_SPLASHSCREEN_H
