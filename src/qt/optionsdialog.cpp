    ...
    mapper(nullptr)
{
    ...
    ui->cypherAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->cypherAtStartup);
    ...
    ui->cypherAtStartup->setToolTip(ui->cypherAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->cypherAtStartup->setText(ui->cypherAtStartup->text().arg(PACKAGE_NAME));

    ui->openCypherConfButton->setToolTip(ui->openCypherConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new CypherUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->cypherAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openCypherConfButton_clicked()
{
