...
#include <config/cypher-config.h> /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatCypherURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + CypherUnits::formatHtmlWithUnit(model->getOptionsModel()->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatCypherURI(info));
}
